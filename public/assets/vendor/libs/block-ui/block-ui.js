...
!function (e, t) {
    ...
    return function () {
        var t = {
            21715: function (e, t, o) {
                var n, i, s;
                !function () {
                    "use strict";
                    i = [o(21145)], void 0 === (s = "function" == typeof (n = function (e) {
                            ...
                            if (!(d = e.extend({}, e.blockUI.defaults, d || {})).ignoreIfBlocked || !e(a).data("blockUI.isBlocked")) {
                                ...
                                if (n || C) {
                                    if (h && d.allowBodyStretch && e.support.boxModel && e("html,body").css("height", "100%"), (n || !e.support.boxModel) && !h) var O = p(a, "borderTopWidth"),
                                        E = p(a, "borderLeftWidth"), M = O ? "(0 - " + O + ")" : 0,
                                        T = E ? "(0 - " + E + ")" : 0;
                        ...
                        function r(t, o) {
                            var n, i, a = t == window, r = e(t), u = r.data("blockUI.history"),
                        ...
                        function u(t) {
                            if ("keydown" === t.type && t.keyCode && 9 == t.keyCode && s && t.data.constrainTabKey) {
                                var o = l, n = !t.shiftKey && t.target === o[o.length - 1],
