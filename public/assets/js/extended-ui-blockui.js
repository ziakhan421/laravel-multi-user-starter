"use strict";
$((function () {
    var s = $("#section-block"), e = $(".btn-section-block"), c = $(".btn-section-block-overlay"),
        t = $(".btn-section-block-spinner"), o = $(".btn-section-block-custom"), r = $(".btn-section-block-multiple"),
        a = $("#card-block"), l = $(".btn-card-block"), i = $(".btn-card-block-overlay"),
        n = $(".btn-card-block-spinner"), v = $(".btn-card-block-custom"), d = $(".btn-card-block-multiple"),
        k = $(".btn-page-block"), b = $(".btn-page-block-overlay"), u = $(".btn-page-block-spinner"),
        f = $(".btn-page-block-custom"), p = $(".btn-page-block-multiple"), g = $(".form-block"),
        m = $(".btn-form-block"), w = $(".btn-form-block-overlay"), y = $(".btn-form-block-spinner"),
        C = $(".btn-form-block-custom"), S = $(".btn-form-block-multiple");
