"use strict";
$((function () {
    var a = $(".datatables-ajax"), t = $(".dt-column-search"), e = $(".dt-advanced-search"), l = $(".dt-responsive"),
        n = $(".start_date"), o = $(".end_date"), s = $(".flatpickr-range");
    s.length && s.flatpickr({
        ...
        onClose: function (a, t, e) {
            var l = "", r = new Date;
            null != a[0] && (l = moment(a[0]).format("MM/DD/YYYY"), n.val(l)), null != a[1] && (r = moment(a[1]).format("MM/DD/YYYY"), o.val(r)), $(s).trigger("change").trigger("keyup")
        }
    }), $.fn.dataTableExt.afnFiltering.length = 0;
    var r = function (a, t, e) {
        $.fn.dataTableExt.afnFiltering.push((function (l, n, o) {
            var s = d(n[a]), r = d(t), c = d(e);
    ...
    if (a.length) a.dataTable({
        processing: !0,
        ajax: assetsPath + "json/ajax.php",
        dom: '<"row"<"col-sm-12 col-md-6"l><"col-sm-12 col-md-6 d-flex justify-content-center justify-content-md-end"f>><"table-responsive"t><"row"<"col-sm-12 col-md-6"i><"col-sm-12 col-md-6"p>>'
    });
    if (t.length) {
        $(".dt-column-search thead tr").clone(!0).appendTo(".dt-column-search thead"), $(".dt-column-search thead tr:eq(1) th").each((function (a) {
            var t = $(this).text();
            $(this).html('<input type="text" class="form-control" placeholder="Search ' + t + '" />'), $("input", this).on("keyup change", (function () {
    ...
    if (e.length) e.DataTable({
        ...
        columnDefs: [{
            className: "control", orderable: !1, targets: 0, render: function (a, t, e, l) {
                return ""
            }
        }],
        orderCellsTop: !0,
        responsive: {
            details: {
                ...
                }), type: "column", renderer: function (a, t, e) {
    ...
    if ($("input.dt-input").on("keyup", (function () {
        !function (a, t) {
            if (5 == a) {
                var l = n.val(), s = o.val();
                "" !== l && "" !== s && ($.fn.dataTableExt.afnFiltering.length = 0, e.dataTable().fnDraw(), r(a, l, s)), e.dataTable().fnDraw()
        ...
        columnDefs: [{
            className: "control", orderable: !1, targets: 0, searchable: !1, render: function (a, t, e, l) {
                return ""
            }
        }, {
            targets: -1, render: function (a, t, e, l) {
                var n = e.status, o = {
